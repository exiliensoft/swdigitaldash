                ...
                <div className="riyaqas-stab">
                    <ul className="nav nav-tabs">
                        <li className="nav-item">
                            <a className="nav-link active" data-toggle="tab" href="#d_tabs_1">Digital</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" data-toggle="tab" href="#d_tabs_2">Curl</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" data-toggle="tab" href="#d_tabs_3">Resize</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" data-toggle="tab" href="#d_tabs_4">Doct</a>
                        </li>
                    </ul>
            ...
            <div className="col-xl-6 col-lg-6 order-lg-12 wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                <div className="img-with-video">
                    <div className="img-wrap">
                        ...
                        <div className="hover">
                            <a href="https://www.youtube.com/watch?v=c7XEhXZ_rsk" className="video-play-btn mfp-iframe"><img src="assets/img/we-provide/3.png" alt="video" /></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="row justify-content-center">
            ...
            <div className="col-lg-6 order-lg-1">
                <div className="sbs-testimonial-slider">
                    ...
                    <div className="sbs-arrowleft"><a id="btn_next" href="#"><i className="fa fa-long-arrow-left"></i></a></div>
                    <div className="sbs-arrowright"><a id="btn_prev" href="#"><i className="fa fa-long-arrow-right"></i></a></div>
                </div>
            </div>
        </div>
    </div>
